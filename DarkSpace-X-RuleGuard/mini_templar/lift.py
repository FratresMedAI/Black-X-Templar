...
Patterns are meta-jailbreak / adversarial framings that sometimes slip under a single
...
_MXT_LIFT_RAW: list[tuple[str, float]] = [
    ...
    # Agent-harness phrasing (rare in enterprise benign)
    ...
    # Agent-UI / tool-shaped smuggling (MxT recall; keep narrow)
