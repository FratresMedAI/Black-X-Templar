...
CONFIDENCE_THRESHOLD = 0.78  # stricter than DarkSpace + tuned for lower FP on benign security prompts
...
SMOOTHING_PERTURBATIONS = 3           # number of random perturbations for SmoothLLM-style voting
