...
def test_real_2026_training_zero_fp_fn(real_2026_rows: list[dict]):
    """Golden path: local 53-row harness must stay clean (safe vs adversarial)."""
    fp = fn = 0
    for row in real_2026_rows:
