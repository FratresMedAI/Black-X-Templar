"""
HTTP surface: same Gray Swan contract as safeguards_adapter, with Mini Templar scoring.
"""
...
app = FastAPI(title="Black x Templar", version=__version__)
...
def health() -> dict[str, str]:
    return {"status": "ok", "version": __version__, "flavor": "black-x-templar", "service": "black-x-templar"}
