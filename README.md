...
```json
{
  ...
  "dataset": "real_2026_training_dataset.jsonl (53 labeled examples from 2025-2026 survey papers + actual misses)",
  "status": "EVALS_SNAPSHOT_2026_04"
}
```

**Interpretation:** 0% FNR on this adversarial slice (no missed attacks); 50% FPR reflects aggressive fail-closed blocking — call out explicitly for reviewers when submitting.
