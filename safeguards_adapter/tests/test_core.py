...
def test_orbit_style_agent_injection_signals():
...
def test_arena_typical_escalation_language_stays_allow():
...
def test_arena_unverified_safety_escalation_blocks():
    c = classify_text(
...
def test_arena_leak_internal_doc_verb_blocks():
